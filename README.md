...
Search and pagination query AniList directly from the browser. Anime pages (`/anime/[id]`) are server-rendered from the same API and cached for an hour.
